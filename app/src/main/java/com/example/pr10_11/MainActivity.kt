...
class MainActivity : AppCompatActivity() {
    ...
    private val colors = arrayOf(intArrayOf(Color.YELLOW,Color.GREEN,Color.RED,Color.RED,Color.GREEN),
        intArrayOf(Color.RED,Color.YELLOW,Color.GREEN,Color.GREEN,Color.RED),
        intArrayOf(Color.GREEN,Color.RED,Color.YELLOW,Color.RED,Color.GREEN),
        intArrayOf(Color.GREEN,Color.RED,Color.GREEN,Color.YELLOW,Color.RED),
        intArrayOf(Color.RED,Color.GREEN,Color.RED,Color.GREEN,Color.YELLOW))
    private val rules = arrayOf(arrayOf(R.drawable.b_draw, R.drawable.b_paper_vs_rock, R.drawable.b_rock_vs_scissors, R.drawable.b_rock_vs_lizard, R.drawable.b_spock_vs_rock),
        arrayOf(R.drawable.b_paper_vs_rock, R.drawable.b_draw, R.drawable.b_scissors_vs_paper, R.drawable.b_lizard_vs_paper, R.drawable.b_paper_vs_spock),
        arrayOf(R.drawable.b_rock_vs_scissors, R.drawable.b_scissors_vs_paper, R.drawable.b_draw, R.drawable.b_scissors_vs_lizard, R.drawable.b_spock_vs_scissors),
        arrayOf(R.drawable.b_rock_vs_lizard, R.drawable.b_lizard_vs_paper, R.drawable.b_scissors_vs_lizard, R.drawable.b_draw, R.drawable.b_lizard_vs_spock),
        arrayOf(R.drawable.b_spock_vs_rock, R.drawable.b_paper_vs_spock, R.drawable.b_spock_vs_scissors, R.drawable.b_lizard_vs_spock, R.drawable.b_draw))
    ...
    fun Generate(view: View){
        ...
        if (click){
            ...
            else Toast.makeText(this,getString(R.string.editText), Toast.LENGTH_LONG).show()
            return
        }
        else Clear()
    }
